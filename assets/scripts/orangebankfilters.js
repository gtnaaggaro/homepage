!(function(){
    var cardsData = {
      cards: [
        ...
        },
        {
          ...
          category: "Bank",
          subcategory: "Bank_getting_started",
          video: 'orange-talk.html',
          videoDuration: '30:00',
          podcast: '',
          podcastDuration: ''
        },
        {
          cardId: '202030504195126',
          image: 'assets/images/orange-hub/orangebook-3.jpg',
          type: 'Webinar',
          readTime: '',
          publishdate: "2019-07-02T07:20:45Z",
        ...
        },
        {
          ...
          podcastDuration: '30:00'
        },
        {
          cardId: '202003704195129',
          image: 'assets/images/orange-hub/orangebook-5.jpg',
          type: 'Podcast',
          readTime: '',
          publishdate: "2021-08-24T07:20:45Z",
          link: '',
          title: 'How to open new Account',
          tags: ['Money2India', 'iMobilePay'],
          viewers: "8500",
          likes: "1800",
          volumeId: '',
          ...
          video: '',
          videoDuration: '',
          podcast: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3',
          podcastDuration: '10:00'
        },
        {
          cardId: '202005041956129',
          image: 'assets/images/orange-hub/orangebook-4.jpg',
          type: 'Video',
          readTime: '',
          publishdate: "2019-08-28T07:20:45Z",
          link: '',
          title: 'Watch this before applying for Moratorium',
          tags: ['Moratorium'],
          viewers: "18500",
          likes: "10800",
          volumeId: '',
        ...
        {
          cardId: '220200504195129',
          image: 'assets/images/orange-hub/orangebook-7.jpg',
          type: 'Infograph',
          readTime: '1mins',
          publishdate: "2019-08-28T07:20:45Z",
          link: 'orange-infograph.html',
          title: 'RBI\'s COVID-19 Moratorium (2.0) relief package clarification by ICICI Bank for Credit Card & Loans',
          tags: ['Money2India', 'iMobilePay'],
          viewers: "18500",
          likes: "10800",
          volumeId: '',
        ...
        {
          cardId: '202005041595129',
          image: 'assets/images/orange-hub/orangebook-5.jpg',
          type: 'Blog',
          readTime: '1mins',
          publishdate: "2019-08-28T07:20:45Z",
          link: 'orange-blog.html',
          title: 'How to plan a Luxury Holiday without going broke',
          tags: ['Money2India', 'iMobilePay'],
          viewers: "18500",
          likes: "10800",
          volumeId: '',
    ...
    $(document).ready(function () {
      renderOfferCards('bank_getting_started');
    ...
    $('.filter-content .search-box-area input').keyup(function () {
      ...
      if (inputText.length > 0) {
        var titleArray = searchItems(tempArray, 'title', inputText);
      ...
      } else renderOfferCards($(".sidebar-content .selection-filters .list-child li.active").attr("id"));
    });
    ...
    $('.sort-dropdown .dropdown-inner li').click(function () {
      ...
      else renderOfferCards('bank_getting_started');
    });

    //Filter cards from sidebar selection category
    $(".sidebar-content .selection-filters li div").click(function (event) {
      ...
      if ($(this).parent().hasClass("list-parent")) {
        renderOfferCards(
          $(this).siblings(".list-child").find("li:first").attr("id")
        );
      } else renderOfferCards($(this).parent().attr("id"));
    });
    
    //Filter video from sidebar selection sub-category
    $(".sidebar-content .selection-filters .list-child li").click(function (event) {
      clearCheckFilters();
      renderOfferCards($(this).attr("id"));
    });

    $(".sidebar-content .list-child li").click(function (event) {
        $(".sidebar-content .list-child li").removeClass("active");
    ...
    function renderOfferCards(filterId) {
      ...
      if (filterId == 'all') {
        ...
        for (let index = 0; index < cardsData['cards'].length; index++) {
          ...
          if (
            element["category"].toLowerCase() == filterId ||
            element["subcategory"].toLowerCase() == filterId||
            element["type"].toLowerCase() == filterId
          ) {
            tempArray.push(element);
          }
          if (
            filters.indexOf(element['volumeId'].toLowerCase()) != -1 ||
            filters.indexOf(element['type'].toLowerCase()) != -1
          ) {
            tempArray.push(element);
          }
        }
    ...
    function createOrangeList(cardData) {
      ...
      for (let index = 0; index < cardData.length; index++) {
        ...
        if (index % cardGroupCount == cardGroupCount - 1) {
          htmlMarkup += '<div\n\
          class="account-variants-card account-variants-curve-10 blue-bg account-variants-padding-20">\n\
          <div class="account-variants-card-with-img">\n\
              <div class="img-wrapper"><img class="account-variants-curve-10"\n\
                      src="assets/images/orange-hub/personal-loan.jpg" alt=""></div>\n\
              <div class=" content-wrapper">\n\
                  <div class="titie-wrapper">\n\
                      <h4>Personal Loan on Credit Cards</h4>\n\
                  </div>\n\
                  <div class="icon-text-lists">\n\
                      <div class="icon-text-list">\n\
                          <img src="assets/images/icons/orange-hub/loan-icon-1.svg" alt="">\n\
                          <p>Loan upto<br>\n\
                              20Lakhs</p>\n\
                      </div>\n\
                      <div class="icon-text-list">\n\
                          <img src="assets/images/icons/orange-hub/loan-icon-2.svg" alt="">\n\
                          <p>Attractive<br>Interest Rates</p>\n\
                      </div>\n\
                      <div class="icon-text-list">\n\
                          <img src="assets/images/icons/orange-hub/loan-icon-3.svg" alt="">\n\
                          <p>Tenure of<br>\n\
                              60 Months</p>\n\
                      </div>\n\
                      <div class="icon-text-list">\n\
                          <img src="assets/images/icons/orange-hub/loan-icon-4.svg" alt="">\n\
                          <p>Minimum<br>\n\
                              Documentaion</p>\n\
                      </div>\n\
                  </div>\n\
                  <div class="button-group">\n\
                      <a href="#" class="ic-btn">Apply now</a>\n\
    ...
    function generateHTML(cardImage, cardType, readTime, timeAgo, pageLink, cardTitle, tagsArr, 
    viewers, likes, cardVideo, cardVideoDuration, cardPodcast, cardPodcastDuration) {
      ...
      var html =
        ...
        ((lowerCaseCardType === "video" || lowerCaseCardType === "webinar") ? '<img src="'+ cardImage +'" alt=""><a href="' + cardVideo +'" class="play-btn"></a>' : 
        (lowerCaseCardType === "podcast") ? '<img src="assets/images/orange-hub/podcast-img.jpg" alt=""><a href="#" data-value="'+ cardPodcast +'" class="play-btn podcast-play-btn"></a>' : 
        '<a href="'+ pageLink + '">' + '<img src="' + cardImage + '" alt="amazon"></a>') +
        ...
        ((lowerCaseCardType === "video" || lowerCaseCardType === "webinar") ? cardVideoDuration + ' | ' + timeAgo: 
        (lowerCaseCardType === "podcast") ? cardPodcastDuration + ' | ' + timeAgo: 
        readTime + ' | ' + timeAgo) +

        '</div>\n\
        </div><a href="'+ ((lowerCaseCardType === "video" || lowerCaseCardType === "webinar") ? cardVideo : pageLink) + '"class="card-title">' +
        cardTitle +
